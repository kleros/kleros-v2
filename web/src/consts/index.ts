...
export const IPFS_GATEWAY = import.meta.env.VITE_REACT_APP_IPFS_GATEWAY || "https://cdn.kleros.link";
export const HERMES_TELEGRAM_BOT_URL =
  import.meta.env.VITE_REACT_APP_HERMES_TELEGRAM_BOT_URL || "https://t.me/HermesTheKlerosV2MessengerBot";
...
export const isProductionDeployment = () => import.meta.env.VITE_REACT_APP_DEPLOYMENT === "mainnet";
...
export const getArbitratorType = (): ArbitratorTypes =>
  _getArbitratorType(import.meta.env.VITE_REACT_APP_ARBITRATOR_TYPE?.toLowerCase());

export const GENESIS_BLOCK_ARBSEPOLIA = BigInt(import.meta.env.VITE_REACT_APP_GENESIS_BLOCK_ARBSEPOLIA ?? 0);
export const GENESIS_BLOCK_ARBMAINNET = BigInt(import.meta.env.VITE_REACT_APP_GENESIS_BLOCK_ARBMAINNET ?? 0);
