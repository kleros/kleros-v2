...
const addChain = async (provider: any, { chainId, chainName, nativeCurrency, rpcUrls, blockExplorerUrls }: Chain) => {
...
const _switchChain = async (provider: any, chainId: keyof typeof SUPPORTED_CHAINS) => {
  return provider.request({
