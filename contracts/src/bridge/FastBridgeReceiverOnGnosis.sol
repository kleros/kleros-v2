...
import "./SafeBridgeReceiverOnGnosis.sol";
 ...
 */
contract FastBridgeReceiverOnGnosis is SafeBridgeReceiverOnGnosis, IFastBridgeReceiver, MerkleProof {
    // ************************************* //
    // *         Enums / Structs           * //
    // ************************************* //
    ...
    constructor(
        ...
        uint256 _genesis
    ) SafeBridgeReceiverOnGnosis(_amb, _safeBridgeSender) {
        deposit = _deposit;
