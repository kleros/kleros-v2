...
import {ArbitratorDummy} from "../ArbitratorDummy.sol";
...
contract ArbitrableDummy is IArbitrableV2, IDisputeTemplateRegistry {
    ...
    constructor(
        ...
        ArbitratorDummy(address(_arbitrator)).register();

        emit DisputeTemplate(++templateId, "", _templateData, _templateDataMappings);
    }
