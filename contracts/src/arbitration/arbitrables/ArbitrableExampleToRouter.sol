...
import "../router/ArbitrationRouter.sol";
...
contract ArbitrableExampleToRouter is IArbitrableV2 {
    ...
    ArbitrationRouter public router;
    ...
    constructor(
        ...
        templateId = router.disputeTemplateRegistry().setDisputeTemplate("", _templateData, _templateDataMappings);
    }
    ...
    function changeRouter(ArbitrationRouter _router) external onlyByGovernor {
        router = _router;
    }
    ...
    function createDispute(string calldata _action) external payable returns (uint256 disputeID) {
        ...
        IArbitratorV2 arbitrator = router.arbitrator();
