...
contract DisputeKitGatedArgentinaConsumerProtection is IDisputeKit, Initializable, UUPSProxiable, ICourtEligibility {
    ...
    function draw(
        ...
        if (_postDrawCheck(_coreDisputeID, drawnAddress, _roundNbVotes)) {
