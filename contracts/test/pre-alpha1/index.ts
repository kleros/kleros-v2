...
describe("Demo pre-alpha1", function () {
  ...
  beforeEach("Setup", async () => {
    ...
    foreignGateway = <ForeignGateway>await ethers.getContract("ForeignGatewayOnEthereum");
    arbitrable = <ArbitrableExample>await ethers.getContract("ArbitrableExample");
    fastBridgeSender = <FastBridgeSender>await ethers.getContract("FastBridgeSenderToEthereumMock");
    homeGateway = <HomeGateway>await ethers.getContract("HomeGatewayToEthereum");
